...
def welcome():
    ...
    return (
        ...
        f"This is a Flask API for Climate Analysis  in Honolulu, Hawaii .<br/><br/><br/>"
        f" <img width='600' src= 'https://www.busytourist.com/wp-content/uploads/2019/08/Sunrise-from-Hanauma-Bay-on-Oahu-Hawaii.jpg'/ >"
